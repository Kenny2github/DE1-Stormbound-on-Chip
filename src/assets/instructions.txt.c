...
const char instructions_data[] =
	...
	"\n"
	"  Units and structures can only be placed behind your front line, which remains\n"
	"      in front of your frontmost unit or structure, but never at the base.\n"
	"\n"
	...
	"\n"
	"  Your opponent's base also counts as an \"enemy\" (but not a unit or structure).\n"
	"                **Deplete your opponent's base health to win.**\n"
	"\n"
